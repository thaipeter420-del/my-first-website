...
class Auth {
    constructor() {
        // ใช้ getAuth() จาก SDK v9+ (ถ้าคุณใช้ v9)
        // หรือ firebase.auth() (ถ้าคุณใช้ v8)
        // ดูจากโค้ดเดิม คุณน่าจะใช้ v8
...
// Create and expose global controller so inline handlers like onclick="authController.logout()" work
